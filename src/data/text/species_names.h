const u8 gSpeciesNames[][POKEMON_NAME_LENGTH + 1] = {
    [SPECIES_NONE] = _("??????????"),
    [SPECIES_BULBASAUR] = _("Meng"),
    [SPECIES_IVYSAUR] = _("Mengie"),
    [SPECIES_VENUSAUR] = _("Mengasaur"),
    [SPECIES_CHARMANDER] = _("Chill"),
    [SPECIES_CHARMELEON] = _("Chilln"),
    [SPECIES_CHARIZARD] = _("ChillnPlay"),
    [SPECIES_SQUIRTLE] = _("Quick"),
    [SPECIES_WARTORTLE] = _("QuickG"),
    [SPECIES_BLASTOISE] = _("QuickGG"),
