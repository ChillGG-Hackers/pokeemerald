...
static __attribute__((section("ewram_data"))) u32 sUnknown_0203BCD4 = 0;
...
static void Task_Hof_TryDisplayAnotherMon(u8 taskId)
{
    ...
    {
        sUnknown_0203BCD4 |= (0x10000 << gSprites[gTasks[taskId].data[currPokeID + 5]].oam.paletteNum);
        if (gTasks[taskId].data[1] <= 4 && currMon[1].species != 0)
        {
            gTasks[taskId].data[1]++;
            BeginNormalPaletteFade(sUnknown_0203BCD4, 0, 12, 12, ((16) | ((29) << 5) | ((24) << 10)));
...
static void Task_HofPC_PrintMonInfo(u8 taskId)
{
    ...
    BlendPalettesUnfaded(sUnknown_0203BCD4, 0xC, ((16) | ((29) << 5) | ((24) << 10)));
