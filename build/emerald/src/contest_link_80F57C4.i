...
# 2 "src/contest_link_80F57C4.c" 2
# 1 "gflib/malloc.h" 1
# 15 "gflib/malloc.h"
extern u8 gHeap[];
...
# 3 "src/contest_link_80F57C4.c" 2
...
# 4 "src/contest_link_80F57C4.c" 2
# 1 "include/battle_gfx_sfx_util.h" 1
# 5 "src/contest_link_80F57C4.c" 2
# 1 "gflib/bg.h" 1
...
# 6 "src/contest_link_80F57C4.c" 2
...
# 7 "src/contest_link_80F57C4.c" 2
...
# 8 "src/contest_link_80F57C4.c" 2
...
void sub_80FCE48(u8);
void sub_80FC894(u8);
# 9 "src/contest_link_80F57C4.c" 2
# 1 "include/data.h" 1
...
# 10 "src/contest_link_80F57C4.c" 2
...
# 11 "src/contest_link_80F57C4.c" 2
# 1 "gflib/dma3.h" 1
# 49 "gflib/dma3.h"
...
# 12 "src/contest_link_80F57C4.c" 2
...
# 13 "src/contest_link_80F57C4.c" 2
...
# 14 "src/contest_link_80F57C4.c" 2
...
# 15 "src/contest_link_80F57C4.c" 2
...
extern const u32 gPokenavOptions_Gfx[];
extern const u16 gPokenavOptions_Pal[];
# 16 "src/contest_link_80F57C4.c" 2
...
# 17 "src/contest_link_80F57C4.c" 2
# 1 "include/link.h" 1
# 98 "include/link.h"
struct LinkStatus
{
...
# 18 "src/contest_link_80F57C4.c" 2
...
bool32 sub_800E540(u16 id, u8 *name);
void WipeTrainerNameRecords(void);
# 19 "src/contest_link_80F57C4.c" 2
...
# 20 "src/contest_link_80F57C4.c" 2
# 1 "include/main.h" 1
# 21 "src/contest_link_80F57C4.c" 2
...
# 22 "src/contest_link_80F57C4.c" 2
# 1 "include/palette.h" 1
# 23 "src/contest_link_80F57C4.c" 2
...
# 24 "src/contest_link_80F57C4.c" 2
# 1 "include/pokemon.h" 1
# 25 "src/contest_link_80F57C4.c" 2
...
# 26 "src/contest_link_80F57C4.c" 2
...
# 27 "src/contest_link_80F57C4.c" 2
# 1 "include/save.h" 1
...
# 28 "src/contest_link_80F57C4.c" 2
...
# 29 "src/contest_link_80F57C4.c" 2
...
# 30 "src/contest_link_80F57C4.c" 2
# 1 "include/sound.h" 1
...
# 31 "src/contest_link_80F57C4.c" 2
...
# 32 "src/contest_link_80F57C4.c" 2
...
# 33 "src/contest_link_80F57C4.c" 2
# 1 "include/task.h" 1
# 34 "src/contest_link_80F57C4.c" 2
...
s16 Sin2(u16 angle);
s16 Cos2(u16 angle);
# 36 "src/contest_link_80F57C4.c" 2
# 1 "include/tv.h" 1
...
# 37 "src/contest_link_80F57C4.c" 2
# 1 "include/util.h" 1
...
# 38 "src/contest_link_80F57C4.c" 2

# 1 "include/constants/game_stat.h" 1
# 40 "src/contest_link_80F57C4.c" 2
# 1 "include/constants/rgb.h" 1
# 41 "src/contest_link_80F57C4.c" 2
# 1 "include/constants/songs.h" 1
# 42 "src/contest_link_80F57C4.c" 2
# 1 "include/constants/tv.h" 1
# 43 "src/contest_link_80F57C4.c" 2
# 1 "include/constants/vars.h" 1
# 44 "src/contest_link_80F57C4.c" 2
...
__attribute__((section("ewram_data"))) struct ContestLink80F57C4 *gUnknown_0203A034 = ((void *)0);
...
void sub_80F57C4(void)
{
    ...
    InitBgsFromTemplates(0, sUnknown_0858D888, (size_t)(sizeof(sUnknown_0858D888) / sizeof((sUnknown_0858D888)[0])));
    for (i = 0; i < 4; i++)
...
void sub_80F591C(void)
{
    ...
    LZDecompressVram(gUnknown_08C19588, (void *)(0x6000000 + (0x4000 * (0))));
...
static void sub_80F7824(u8 taskId)
{
    ...
    {
        gTasks[taskId].data[10] = 0;
        sub_80F69B8(gTasks[taskId].data[2], monIndex, gTasks[taskId].data[11], 0, gContestMons[monIndex].personality);
...
static void sub_80F7DF4(void)
{
    ...
    gUnknown_0203A034->unk8 = AllocZeroed(0x800);
    gUnknown_0203A034->unkC[0] = AllocZeroed(0x800);
    gUnknown_0203A034->unkC[1] = AllocZeroed(0x800);
    gUnknown_0203A034->unkC[2] = AllocZeroed(0x800);
    gUnknown_0203A034->unkC[3] = AllocZeroed(0x800);
...
static void sub_80F7E64(void)
{
    { Free(gUnknown_0203A034->unk0); gUnknown_0203A034->unk0 = ((void *)0); };
    { Free(gUnknown_0203A034->unk4); gUnknown_0203A034->unk4 = ((void *)0); };
    { Free(gUnknown_0203A034->unk8); gUnknown_0203A034->unk8 = ((void *)0); };
    { Free(gUnknown_0203A034->unkC[0]); gUnknown_0203A034->unkC[0] = ((void *)0); };
    { Free(gUnknown_0203A034->unkC[1]); gUnknown_0203A034->unkC[1] = ((void *)0); };
    { Free(gUnknown_0203A034->unkC[2]); gUnknown_0203A034->unkC[2] = ((void *)0); };
    { Free(gUnknown_0203A034->unkC[3]); gUnknown_0203A034->unkC[3] = ((void *)0); };
    { Free(gUnknown_0203A034->unk1C); gUnknown_0203A034->unk1C = ((void *)0); };
    { Free(gUnknown_0203A034); gUnknown_0203A034 = ((void *)0); };
    FreeMonSpritesGfx();
}
