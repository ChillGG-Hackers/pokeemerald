...
static __attribute__((section("ewram_data"))) struct RaySceneStruct *sRayScene = ((void *)0);
...
static void sub_81D6FE0(void)
{
    ...
    InitBgsFromTemplates(0, sUnknown_0862A888, (size_t)(sizeof(sUnknown_0862A888) / sizeof((sUnknown_0862A888)[0])));
...
static void sub_81D7E10(void)
{
    ResetVramOamAndBgCntRegs();
    ResetBgsAndClearDma3BusyFlags(0);
    InitBgsFromTemplates(1, sUnknown_0862AA54, (size_t)(sizeof(sUnknown_0862AA54) / sizeof((sUnknown_0862AA54)[0])));
    SetBgTilemapBuffer(0, sRayScene->tilemapBuffers[0]);
    SetBgTilemapBuffer(1, sRayScene->tilemapBuffers[1]);
    SetBgTilemapBuffer(2, sRayScene->tilemapBuffers[2]);
    ResetAllBgsCoordinates();
...
static void sub_81D82B0(void)
{
    ResetVramOamAndBgCntRegs();
    ResetBgsAndClearDma3BusyFlags(0);
    InitBgsFromTemplates(0, sUnknown_0862AACC, (size_t)(sizeof(sUnknown_0862AACC) / sizeof((sUnknown_0862AACC)[0])));
    SetBgTilemapBuffer(0, sRayScene->tilemapBuffers[0]);
    SetBgTilemapBuffer(1, sRayScene->tilemapBuffers[1]);
    SetBgTilemapBuffer(2, sRayScene->tilemapBuffers[2]);
...
static void sub_81D8828(void)
{
    ResetVramOamAndBgCntRegs();
    ResetBgsAndClearDma3BusyFlags(0);
    InitBgsFromTemplates(0, sUnknown_0862AB44, (size_t)(sizeof(sUnknown_0862AB44) / sizeof((sUnknown_0862AB44)[0])));
    SetBgTilemapBuffer(0, sRayScene->tilemapBuffers[0]);
    SetBgTilemapBuffer(1, sRayScene->tilemapBuffers[1]);
    SetBgTilemapBuffer(2, sRayScene->tilemapBuffers[2]);
    SetBgTilemapBuffer(3, sRayScene->tilemapBuffers[3]);
...
static void sub_81D8C38(void)
{
    ResetVramOamAndBgCntRegs();
    ResetBgsAndClearDma3BusyFlags(0);
    InitBgsFromTemplates(1, sUnknown_0862AD08, (size_t)(sizeof(sUnknown_0862AD08) / sizeof((sUnknown_0862AD08)[0])));
    SetBgTilemapBuffer(0, sRayScene->tilemapBuffers[0]);
    SetBgTilemapBuffer(1, sRayScene->tilemapBuffers[1]);
    SetBgTilemapBuffer(2, sRayScene->tilemapBuffers[2]);
    ResetAllBgsCoordinates();
