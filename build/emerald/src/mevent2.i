...
void sub_801AFD8(void)
{
    { vu32 tmp = (vu32)(0); CpuSet((void *)&tmp, &gSaveBlock1Ptr->unk_322C, 0x04000000 | 0x01000000 | ((sizeof(gSaveBlock1Ptr->unk_322C))/(32/8) & 0x1FFFFF)); };
    sub_801B180();
    sub_811F8BC();
}
...
static void s_DestroyWonderNews(void)
{
    { vu32 tmp = (vu32)(0); CpuSet((void *)&tmp, GetSavedWonderNews(), 0x04000000 | 0x01000000 | ((sizeof(gSaveBlock1Ptr->unk_322C.wonderNews.data))/(32/8) & 0x1FFFFF)); };
...
static void sub_801B330(void)
{
    { vu32 tmp = (vu32)(0); CpuSet((void *)&tmp, &gSaveBlock1Ptr->unk_322C.wonderCard.data, 0x04000000 | 0x01000000 | ((sizeof(struct WonderCard))/(32/8) & 0x1FFFFF)); };
    gSaveBlock1Ptr->unk_322C.wonderCard.crc = 0;
}

static void sub_801B368(void)
{
    { vu32 tmp = (vu32)(0); CpuSet((void *)&tmp, sav1_get_mevent_buffer_2(), 0x04000000 | 0x01000000 | ((18 *sizeof(u16))/(32/8) & 0x1FFFFF)); };
...
static void sub_801B9F8(void)
{
    { vu32 tmp = (vu32)(0); CpuSet((void *)&tmp, gSaveBlock1Ptr->unk_322C.unk_344, 0x04000000 | 0x01000000 | ((sizeof(gSaveBlock1Ptr->unk_322C.unk_344))/(32/8) & 0x1FFFFF)); };
}
