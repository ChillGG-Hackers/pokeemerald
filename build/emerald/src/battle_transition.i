...
static bool8 Phase2_Regi_Func1(struct Task *task)
{
    ...
    sub_8149F58(&dst1, &dst2);
    { vu16 tmp = (vu16)(0); CpuSet((void *)&tmp, dst1, 0x00000000 | 0x01000000 | ((0x800)/(16/8) & 0x1FFFFF)); };
    CpuSet(gUnknown_085BBC14, dst2, 0x00000000 | ((0x2000)/(16/8) & 0x1FFFFF));
...
static bool8 Phase2_BigPokeball_Func1(struct Task *task)
{
    ...
    sub_8149F58(&dst1, &dst2);
    { vu16 tmp = (vu16)(0); CpuSet((void *)&tmp, dst1, 0x00000000 | 0x01000000 | ((0x800)/(16/8) & 0x1FFFFF)); };
    CpuSet(sBigPokeball_Tileset, dst2, 0x00000000 | ((0x580)/(16/8) & 0x1FFFFF));
...
static bool8 Phase2_Regice_Func2(struct Task *task)
{
    ...
    CpuSet(gUnknown_085BC314, dst1, 0x00000000 | ((0x500)/(16/8) & 0x1FFFFF));
    sub_8149F98(gScanlineEffectRegBuffers[0], 0, task->data[4], 132, task->data[5], 160);
...
static bool8 Phase2_Registeel_Func2(struct Task *task)
{
    ...
    CpuSet(gUnknown_085BCB14, dst1, 0x00000000 | ((0x500)/(16/8) & 0x1FFFFF));
    sub_8149F98(gScanlineEffectRegBuffers[0], 0, task->data[4], 132, task->data[5], 160);
...
static bool8 Phase2_Regirock_Func2(struct Task *task)
{
    ...
    CpuSet(gUnknown_085BD314, dst1, 0x00000000 | ((0x500)/(16/8) & 0x1FFFFF));
    sub_8149F98(gScanlineEffectRegBuffers[0], 0, task->data[4], 132, task->data[5], 160);
...
static bool8 Phase2_Mugshot_Func4(struct Task *task)
{
    ...
    sub_8148484(task->data[13], 0);
    sub_8148484(task->data[14], 1);
    sub_814849C(task->data[13]);
...
static bool8 Phase2_Mugshot_Func5(struct Task *task)
{
    sTransitionStructPtr->BG0HOFS_1 -= 8;
    sTransitionStructPtr->BG0HOFS_2 += 8;
    if (sub_81484B8(task->data[13]))
    {
        task->data[0]++;
        sub_814849C(task->data[14]);
    }
    return 0;
}
...
static bool8 Phase2_RectangularSpiral_Func1(struct Task *task)
{
    ...
    sub_8149F58(&dst1, &dst2);
    CpuSet(sShrinkingBoxTileset, dst2, 0x00000000 | ((0x20)/(16/8) & 0x1FFFFF));
    CpuSet(sShrinkingBoxTileset + 0x70, dst2 + 0x20, 0x00000000 | ((0x20)/(16/8) & 0x1FFFFF));
...
static bool8 Phase2_Rayquaza_Func3(struct Task *task)
{
    ...
    sub_8149F58(&dst1, &dst2);
    { vu16 tmp = (vu16)(0); CpuSet((void *)&tmp, dst1, 0x00000000 | 0x01000000 | ((0x800)/(16/8) & 0x1FFFFF)); };
    CpuSet(gUnknown_085BF6A0, dst2, 0x00000000 | ((0x2000)/(16/8) & 0x1FFFFF));
...
static bool8 Phase2_Rayquaza_Func4(struct Task *task)
{
    ...
    sub_8149F58(&dst1, &dst2);
    CpuSet(gUnknown_085C6BE0, dst1, 0x00000000 | ((0x1000)/(16/8) & 0x1FFFFF));
    task->data[0]++;
    return 0;
}
...
static void Phase2Task_29(u8 taskId)
{
    while (sPhase2_29_Funcs[gTasks[taskId].data[0]](&gTasks[taskId]));
}

static void Phase2Task_30(u8 taskId)
{
    while (sPhase2_30_Funcs[gTasks[taskId].data[0]](&gTasks[taskId]));
}
...
static void Phase2Task_31(u8 taskId)
{
    while (sPhase2_31_Funcs[gTasks[taskId].data[0]](&gTasks[taskId]));
}

static void Phase2Task_33(u8 taskId)
{
    while (sPhase2_33_Funcs[gTasks[taskId].data[0]](&gTasks[taskId]));
}

static void Phase2Task_32(u8 taskId)
{
    while (sPhase2_32_Funcs[gTasks[taskId].data[0]](&gTasks[taskId]));
}
...
static bool8 Phase2_31_Func2(struct Task *task)
{
    CopyRectToBgTilemapBufferRect(0, gUnknown_085C8928, 0, 0, 4, 4, task->data[2], task->data[3], 4, 4, 0xF, 0, 0);
    CopyBgTilemapBufferToVram(0);
