...
void InitAndLaunchChosenStatusAnimation(bool8 isStatus2, u32 status)
{
    ...
    if (!isStatus2)
    {
        ...
        else if (status == 0x8 || status & 0x80)
...
bool8 BattleInitAllSprites(u8 *state1, u8 *battlerId)
{
    ...
    case 2:
        ...
        break;
    case 3:
        if ((gBattleTypeFlags & 0x0080) && *battlerId == 0)
...
void HandleLowHpMusicChange(struct Pokemon *mon, u8 battlerId)
{
    ...
    else
    {
        ...
        if (IsDoubleBattle() && !gBattleSpritesDataPtr->battlerData[battlerId ^ 2].lowHpSong)
        {
            m4aSongNumStop(90);
            return;
        }
...
bool32 ShouldPlayNormalMonCry(struct Pokemon *mon)
{
    ...
    if (GetMonData(mon, 55) & ((0x7 | 0x8 | 0x10 | 0x20 | 0x40 | 0x80) | 0xF00))
        return 0;
