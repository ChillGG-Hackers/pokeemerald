...
sFiller:
	.short	0x0
	.type	 gUnknown_0203CDA4,object
	.size	 gUnknown_0203CDA4,4
gUnknown_0203CDA4:
	.byte	0x0
	.space	3
	.align	1, 0
	.type	 gUnknown_0203CDA8,object
	.size	 gUnknown_0203CDA8,2
gUnknown_0203CDA8:
	.short	0x0
	.align	2, 0
	.type	 gUnknown_0203CDAC,object
	.size	 gUnknown_0203CDAC,128
gUnknown_0203CDAC:
	.word	0x0
	.space	124
...
sub_8197200:
	...
	bx	r0
.Lfe3:
	.size	 sub_8197200,.Lfe3-sub_8197200
	.align	2, 0
...
.L352:
	...
	bx	r1
.Lfe85:
	.size	 sub_8199134,.Lfe85-sub_8199134
	.align	2, 0
	.globl	sub_81991F8
	.type	 sub_81991F8,function
	.thumb_func
sub_81991F8:
	push	{r4, r5, r6, r7, lr}
	mov	r7, r8
...
.L364:
	...
	bx	r1
.Lfe86:
	.size	 sub_81991F8,.Lfe86-sub_81991F8
	.align	2, 0
	.globl	sub_8199284
...
.Lfe98:
	...
	.align	2, 0
	.globl	clear_scheduled_bg_copies_to_vram
	.type	 clear_scheduled_bg_copies_to_vram,function
	.thumb_func
...
.L505:
	.align	2, 0
.L504:
	.word	gUnknown_0203CDA4
.Lfe99:
	.size	 clear_scheduled_bg_copies_to_vram,.Lfe99-clear_scheduled_bg_copies_to_vram
	.align	2, 0
	.globl	schedule_bg_copy_tilemap_to_vram
	.type	 schedule_bg_copy_tilemap_to_vram,function
	.thumb_func
...
.L507:
	.word	gUnknown_0203CDA4
.Lfe100:
	.size	 schedule_bg_copy_tilemap_to_vram,.Lfe100-schedule_bg_copy_tilemap_to_vram
	.align	2, 0
	.globl	do_scheduled_bg_tilemap_copies_to_vram
	.type	 do_scheduled_bg_tilemap_copies_to_vram,function
	.thumb_func
...
.L514:
	.word	gUnknown_0203CDA4
.Lfe101:
	.size	 do_scheduled_bg_tilemap_copies_to_vram,.Lfe101-do_scheduled_bg_tilemap_copies_to_vram
	.align	2, 0
	.globl	reset_temp_tile_data_buffers
	.type	 reset_temp_tile_data_buffers,function
	.thumb_func
...
.L523:
	.align	2, 0
.L522:
	.word	gUnknown_0203CDA8
	.word	gUnknown_0203CDAC
.Lfe102:
	.size	 reset_temp_tile_data_buffers,.Lfe102-reset_temp_tile_data_buffers
	.align	2, 0
	.globl	free_temp_tile_data_buffers_if_possible
	.type	 free_temp_tile_data_buffers_if_possible,function
	.thumb_func
...
.L533:
	...
	bx	r1
.Lfe103:
	.size	 free_temp_tile_data_buffers_if_possible,.Lfe103-free_temp_tile_data_buffers_if_possible
	.align	2, 0
	.globl	decompress_and_copy_tile_data_to_vram
	.type	 decompress_and_copy_tile_data_to_vram,function
	.thumb_func
...
.L540:
	...
	bx	r1
.Lfe104:
	.size	 decompress_and_copy_tile_data_to_vram,.Lfe104-decompress_and_copy_tile_data_to_vram
	.align	2, 0
...
.Lfe121:
	.size	 sub_819A2BC,.Lfe121-sub_819A2BC
	.align	2, 0
	.globl	blit_move_info_icon
	.type	 blit_move_info_icon,function
	.thumb_func
blit_move_info_icon:
	push	{r4, r5, lr}
	add	sp, sp, #-0x18
...
.Lfe122:
	.size	 blit_move_info_icon,.Lfe122-blit_move_info_icon
	.align	2, 0
