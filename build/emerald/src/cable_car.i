...
__attribute__((section("ewram_data"))) u8 gUnknown_0203ABB0 = 0;
__attribute__((section("ewram_data"))) u8 gUnknown_0203ABB1 = 0;
__attribute__((section("ewram_data"))) u8 gUnknown_0203ABB2 = 0;
__attribute__((section("ewram_data"))) u8 gUnknown_0203ABB3 = 0;
__attribute__((section("ewram_data"))) u8 gUnknown_0203ABB4 = 0;
__attribute__((section("ewram_data"))) u8 gUnknown_0203ABB5 = 0;
...
static void CableCarMainCallback_Setup(void)
{
    ...
    default:
        ...
        { void *_dest = (void *)0x7000000; u32 _size = 0x400; { vu32 tmp = (vu32)(0); { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(&tmp); dmaRegs[1] = (vu32)(_dest); dmaRegs[2] = (vu32)((0x8000 | 0x0000 | 0x0400 | 0x0100 | 0x0000) << 16 | ((_size)/(32/8))); dmaRegs[2]; }; }; };
        { void *_dest = (void *)0x5000000; u32 _size = 0x400; { vu16 tmp = (vu16)(0); { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(&tmp); dmaRegs[1] = (vu32)(_dest); dmaRegs[2] = (vu32)((0x8000 | 0x0000 | 0x0000 | 0x0100 | 0x0000) << 16 | ((_size)/(16/8))); dmaRegs[2]; }; }; };
    ...
    case 1:
        ...
        InitBgsFromTemplates(0, gCableCarBgTemplates, (size_t)(sizeof(gCableCarBgTemplates) / sizeof((gCableCarBgTemplates)[0])));
...
static void CleanupCableCar(void)
{
    ...
    { Free(sCableCar->mountainTilemap); sCableCar->mountainTilemap = ((void *)0); };
    { Free(sCableCar->treeTilemap); sCableCar->treeTilemap = ((void *)0); };
    { Free(sCableCar->mtChimneyTilemap); sCableCar->mtChimneyTilemap = ((void *)0); };
