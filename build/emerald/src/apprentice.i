...
static const bool8 sValidApprenticeMoves[355] =
{
    [0] = 0,
    [1] = 0,
    [2] = 1,
        ...
        else
        {
            ...
            else
            {
                ...
                do
                {
                    ...
                    moveId = learnset[learnsetId] & 0x01FF;
                    shouldUseMove = 1;
