...
# 1 "include/constants/species.h" 1
# 16 "src/pokenav_conditions_1.c" 2
...
void sub_81CD824(s16 arg0, u8 arg1)
{
    ...
    {
        sub_81CD624(structPtr->unk6368[arg1], arg0, 0);
        boxId = unkPtr->unk4[arg0].boxId;
        structPtr->unk6320[arg1][0] = 0xFC;
    ...
    {
        for (i = 0; i < 12; i++)
            structPtr->unk6368[arg1][i] = 0x00;
        structPtr->unk6368[arg1][i] = 0xFF;

        for (i = 0; i < 8; i++)
            structPtr->unk6320[arg1][i] = 0x00;
        structPtr->unk6320[arg1][i] = 0xFF;
    }
}
...
void sub_81CDA1C(s16 arg0, u8 arg1)
{
    ...
    if (arg0 != (sub_81CDD5C() != 0 ? unkPtr->unk0 : unkPtr->unk0 - 1))
    {
        ...
        structPtr->unk6428.unk0[arg1][0] = GetBoxOrPartyMonData(boxId, monId, 22, ((void *)0));
        structPtr->unk6428.unk0[arg1][1] = GetBoxOrPartyMonData(boxId, monId, 47, ((void *)0));
        structPtr->unk6428.unk0[arg1][2] = GetBoxOrPartyMonData(boxId, monId, 33, ((void *)0));
        structPtr->unk6428.unk0[arg1][3] = GetBoxOrPartyMonData(boxId, monId, 24, ((void *)0));
        structPtr->unk6428.unk0[arg1][4] = GetBoxOrPartyMonData(boxId, monId, 23, ((void *)0));
        structPtr->unk6780[arg1] = (GetBoxOrPartyMonData(boxId, monId, 48, ((void *)0)) != 255)
                                 ? GetBoxOrPartyMonData(boxId, monId, 48, ((void *)0)) / 29u
                                 : 9;
        structPtr->unk6783[arg1] = GetBoxOrPartyMonData(boxId, monId, 8, ((void *)0));
