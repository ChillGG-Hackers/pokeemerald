...
{
    sUnknown_085B1F58, 0x2000, 0x1000
};
...
void CB2_StartWallClock(void)
{
    ...
    LZ77UnCompVram(gUnknown_08DCC648, (u16 *)(0x6000000 + (0x800 * (7))));
...
void CB2_ViewWallClock(void)
{
    ...
    LoadWallClockGraphics();
    LZ77UnCompVram(gUnknown_08DCC908, (u16 *)(0x6000000 + (0x800 * (7))));
...
static void SpriteCB_AMIndicator(struct Sprite *sprite)
{
    if (gTasks[sprite->data[0]].data[5])
    {
