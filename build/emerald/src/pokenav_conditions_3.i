...
static u32 sub_81CF418(s32 state)
{
    ...
    {
    case 0:
        InitBgTemplates(gUnknown_08623590, (sizeof(gUnknown_08623590)/sizeof(*(gUnknown_08623590))));
...
static void sub_81CF7F4(struct PokenavSub8 * ptr)
{
    ...
    *gStringVar1 = 0xFF;
    ...
    AddTextPrinterParameterized(ptr->winid, 1, gStringVar2, 4, 1, 0xFF, ((void *)0));
    ConvertIntToDecimalStringN(gStringVar1, r7, STR_CONV_MODE_RIGHT_ALIGN, 3);
    AddTextPrinterParameterized(ptr->winid, 1, gStringVar1, 34, 1, 0xFF, ((void *)0));
