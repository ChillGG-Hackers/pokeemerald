...
void LoadPokedexAreaMapGfx(const struct PokedexAreaMapTemplate *template)
{
    ...
    if (mode == 0)
    {
        ...
        sub_8199D3C(decompress_and_copy_tile_data_to_vram(template->bg, sPokedexAreaMap_Tilemap, 0, 0, 1), template->offset, 32, 32, 0);
    }
    else
    {
        ...
        sub_8199D3C(decompress_and_copy_tile_data_to_vram(template->bg, sPokedexAreaMapAffine_Tilemap, 0, 0, 1), template->offset, 64, 64, 1);
    }
