...
# 34 "src/field_player_avatar.c" 2
...
static const u8 sPlayerAvatarGfxToStateFlag[2][5][2] =
{
    [0] =
    {
        ...
        {63, (1 << PLAYER_AVATAR_STATE_ACRO_BIKE)},
        {2, (1 << PLAYER_AVATAR_STATE_SURFING)},
        {111, (1 << PLAYER_AVATAR_STATE_UNDERWATER)},
    },
    [1] =
    {
        {89, (1 << PLAYER_AVATAR_STATE_NORMAL)},
        {90, (1 << PLAYER_AVATAR_STATE_MACH_BIKE)},
        {91, (1 << PLAYER_AVATAR_STATE_ACRO_BIKE)},
        {92, (1 << PLAYER_AVATAR_STATE_SURFING)},
        {112, (1 << PLAYER_AVATAR_STATE_UNDERWATER)},
    }
};
...
static void PlayerNotOnBikeMoving(u8 direction, u16 heldKeys)
{
    ...
    if (!(gPlayerAvatar.flags & (1 << PLAYER_AVATAR_STATE_UNDERWATER)) && (heldKeys & 0x0002) && FlagGet((((0x500 + 864 - 1) + 1) + 0x60))
...
static u8 PlayerAvatar_DoSecretBaseMatJump(struct Task *task, struct ObjectEvent *objectEvent)
{
    ...
    if (ObjectEventClearHeldMovementIfFinished(objectEvent))
    {
        ...
        {
            gPlayerAvatar.preventStep = 0;
            gPlayerAvatar.transitionFlags |= (1 << PLAYER_AVATAR_STATE_FIELD_MOVE);
...
# 1709 "src/field_player_avatar.c"
void StartFishing(u8 rod)
{
