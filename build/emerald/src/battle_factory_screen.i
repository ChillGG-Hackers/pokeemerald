...
# 58 "src/battle_factory_screen.c"
...
static void CreateFrontierFactorySelectableMons(u8 firstMonId)
{
    ...
    for (i = 0; i < 6; i++)
    {
        ...
        SetMonData(&sFactorySelectScreen->mons[i + firstMonId].monData, 12, &gBattleFrontierHeldItems[gFacilityTrainerMons[monSetId].itemTableId]);
    }
}
