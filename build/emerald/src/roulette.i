...
# 18 "src/roulette.c" 2
# 1 "include/roulette_util.h" 1



# 1 "include/roulette.h" 1
# 5 "include/roulette_util.h" 2
...
__attribute__((section("ewram_data"))) struct Roulette
{
    u8 var00;
    u8 var01;
    u8 var02;
    ...
    u16 *unk_397C;
} *gUnknown_0203AB88 = ((void *)0);
__attribute__((section("ewram_data"))) u8 gUnknown_0203AB8C = 0;
...
static void sub_8140264(void)
{
    ...
    TransferPlttBuffer();
    sub_8142814();
    SetGpuReg(0x14, 0x200 - gUnknown_0203AB88->var26);
    if (gUnknown_0203AB88->var01)
        SetGpuReg(0x52, gUnknown_0203AB88->var34);
    if (gUnknown_0203AB88->var2A != 0)
    {
        { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(&gUnknown_0203AB88->tilemapBuffers[2][0xE0]); dmaRegs[1] = (vu32)((void *)(0x6000000 + (0x800 * (4))) + 0x1C0); dmaRegs[2] = (vu32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | ((0x340)/(16/8))); dmaRegs[2]; };
    ...
    case 1:
        ...
        ShowBg(0);
        { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(&gUnknown_0203AB88->tilemapBuffers[0][0xE0]); dmaRegs[1] = (vu32)((void *)(0x6000000 + (0x800 * (31))) + 0x1C0); dmaRegs[2] = (vu32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | ((0x340)/(16/8))); dmaRegs[2]; };
...
static void sub_8140388(void)
{
    ...
    InitBgsFromTemplates(1, gUnknown_085B6140, (size_t)(sizeof(gUnknown_085B6140) / sizeof((gUnknown_085B6140)[0])));
...
{
    { Free(gUnknown_0203AB88->unk_397C); gUnknown_0203AB88->unk_397C = ((void *)0); };
    ...
    { Free(gUnknown_0203AB88); gUnknown_0203AB88 = ((void *)0); };
}

static void sub_8140470(void)
{
    u8 i;
    u16 arr[3] = {((24) | ((4) << 5) | ((10) << 10)), ((10) | ((19) << 5) | ((6) << 10)), ((24) | ((4) << 5) | ((10) << 10))};
...
static void sub_81405CC(void)
{
    ...
    case 6:
        ...
        AddTextPrinterParameterized(gUnknown_0203AB8C, 1, Roulette_Text_ControlsInstruction, 0, 1, 0xFF, ((void *)0));
...
static void sub_8140914(u8 taskId)
{
    ...
    DrawStdWindowFrame(gUnknown_0203AB8C, 0);
    AddTextPrinterParameterized(gUnknown_0203AB8C, 1, Roulette_Text_KeepPlaying, 0, 1, 0xFF, 0);
    CopyWindowToVram(gUnknown_0203AB8C, 3);
...
static void sub_8140D6C(u8 r0)
{
    u8 z = 0;
    bool8 var0 = 0;
    if (!(gMain.newKeys & 0x0040) || ((var0 = 1), sub_8140CA8(&gTasks[r0].data[4], 0)))
        if (!(gMain.newKeys & 0x0080) || ((var0 = 1), sub_8140CA8(&gTasks[r0].data[4], 1)))
            if (!(gMain.newKeys & 0x0020) || ((var0 = 1), sub_8140CA8(&gTasks[r0].data[4], 2)))
                if (!(gMain.newKeys & 0x0010) || ((var0 = 1), sub_8140CA8(&gTasks[r0].data[4], 3)))
                    if (var0)
                    {
                        u8 i;
...
static void sub_8141344(u8 taskId)
{
    ...
    g = ({ s16 v = (g); float f = (float)v; if(v < 0) f += 65536.0f; f; }) / 5.0f;
    gUnknown_0203AB88->var82 = g * 3;
    gUnknown_0203AB88->var86 = gUnknown_0203AB88->var84 = g;

    gUnknown_0203AB88->var88 = ({ s16 v = (angles[(rand & 1) + r5]); float f = (float)v; if(v < 0) f += 65536.0f; f; });
    gUnknown_0203AB88->var8C = ({ s16 v = (gUnknown_085B6348[gUnknown_0203AB88->var04_0].var18); float f = (float)v; if(v < 0) f += 65536.0f; f; });
    gUnknown_0203AB88->var90 = ((gUnknown_0203AB88->var8C * 0.5f) - gUnknown_0203AB88->var8C) / ({ s16 v = (gUnknown_0203AB88->var82); float f = (float)v; if(v < 0) f += 65536.0f; f; });
    gUnknown_0203AB88->var94 = 68.0f;
    gUnknown_0203AB88->var9C = 0.0f;
    gUnknown_0203AB88->var98 = -(8.0f / ({ s16 v = (gUnknown_0203AB88->var82); float f = (float)v; if(v < 0) f += 65536.0f; f; }));
...
static void sub_814189C(u8 taskId)
{
    ...
    case 2:
        if (gTasks[taskId].data[2] == 12)
        {
            PlayFanfare(389);
            DrawStdWindowFrame(gUnknown_0203AB8C, 0);
            AddTextPrinterParameterized(gUnknown_0203AB8C, 1, Roulette_Text_Jackpot, 0, 1, 0xFF, ((void *)0));
            CopyWindowToVram(gUnknown_0203AB8C, 3);
        }
        else
        {
            PlayFanfare(390);
            DrawStdWindowFrame(gUnknown_0203AB8C, 0);
            AddTextPrinterParameterized(gUnknown_0203AB8C, 1, Roulette_Text_ItsAHit, 0, 1, 0xFF, ((void *)0));
            CopyWindowToVram(gUnknown_0203AB8C, 3);
        }
        break;
    case 0:
    default:
        m4aSongNumStart(32);
        DrawStdWindowFrame(gUnknown_0203AB8C, 0);
        AddTextPrinterParameterized(gUnknown_0203AB8C, 1, Roulette_Text_NothingDoing, 0, 1, 0xFF, ((void *)0));
        CopyWindowToVram(gUnknown_0203AB8C, 3);
        break;
    }
    gTasks[taskId].data[1] = 0;
...
static void sub_8141A18(u8 taskId)
{
    ...
    DrawStdWindowFrame(gUnknown_0203AB8C, 0);
    AddTextPrinterParameterized(gUnknown_0203AB8C, 1, gStringVar4, 0, 1, 0xFF, ((void *)0));
    CopyWindowToVram(gUnknown_0203AB8C, 3);
...
static void sub_8141AC0(u8 taskId)
{
    sub_8151A9C(&gUnknown_0203AB88->varB8, 0xFFFF);
    gUnknown_0203AB88->varB8.var04[13].var00_7 = gUnknown_0203AB88->varB8.var04[14].var00_7 = gUnknown_0203AB88->varB8.var04[15].var00_7 = 0;
    gSprites[gUnknown_0203AB88->var3C[7 + gUnknown_085B6154[gTasks[taskId].data[12]].var00]].invisible = 1;
...
static void sub_8141B58(u8 taskId)
{
    ...
    sub_81424FC(0);
    gSprites[gUnknown_0203AB88->var3C[48]].invisible = 1;
    for (i = 0; i < 4; i++)
    {
        gSprites[gUnknown_0203AB88->var3C[i + 41]].oam.tileNum =
            gSprites[gUnknown_0203AB88->var3C[i + 41]].sheetTileStart
    ...
    if (gTasks[taskId].data[13] >= gUnknown_0203AB88->var19)
    {
        ...
        {
            DrawStdWindowFrame(gUnknown_0203AB8C, 0);
            AddTextPrinterParameterized(gUnknown_0203AB8C, 1, Roulette_Text_BoardWillBeCleared, 0, 1, 0xFF, ((void *)0));
            CopyWindowToVram(gUnknown_0203AB8C, 3);
        ...
        {
            DrawStdWindowFrame(gUnknown_0203AB8C, 0);
            AddTextPrinterParameterized(gUnknown_0203AB8C, 1, Roulette_Text_CoinCaseIsFull, 0, 1, 0xFF, ((void *)0));
            CopyWindowToVram(gUnknown_0203AB8C, 3);
    ...
    {
        DrawStdWindowFrame(gUnknown_0203AB8C, 0);
        AddTextPrinterParameterized(gUnknown_0203AB8C, 1, Roulette_Text_NoCoinsLeft, 0, 1, 0xFF, ((void *)0));
        CopyWindowToVram(gUnknown_0203AB8C, 3);
...
static void dp01t_12_3_battle_menu(u8 taskId)
{
    ...
    for (i = 0; i < 12; i++)
    {
        gSprites[gUnknown_0203AB88->var3C[i + 7]].invisible = 0;
    }
...
static void sub_8141E7C(u8 taskId)
{
    if (UpdatePaletteFade() == 0)
    {
        SetVBlankCallback(((void *)0));
...
static void sub_8141EF8(u8 taskId)
{
    if (gUnknown_0203AB88->varA8 == 0 || gMain.newKeys & gUnknown_0203AB88->varAA)
    {
        ...
        if (gUnknown_0203AB88->varAA > 0)
            PlaySE(5);
        gUnknown_0203AB88->varAC = ((void *)0);
...
static void sub_8142814(void)
{
    s32 x1;
    s32 x2;
    SetGpuReg(0x20, gUnknown_0203AB88->var2C.a);
    SetGpuReg(0x22, gUnknown_0203AB88->var2C.b);
    SetGpuReg(0x24, gUnknown_0203AB88->var2C.c);
    SetGpuReg(0x26, gUnknown_0203AB88->var2C.d);
    ...
    SetGpuReg(0x28, x1);
    SetGpuReg(0x2a, (x1 & 0x0fff0000) >> 16);
    SetGpuReg(0x2c, x2);
    SetGpuReg(0x2e, (x2 & 0x0fff0000) >> 16);
}
...
static void sub_8142E70(u8 r0, u8 r1)
{
    ...
    case 1:
        for (i = 0; i < 19; i++)
        {
            gSprites[gUnknown_0203AB88->var3C[i + 29]].invisible = 1;
        }
        break;
    case 0:
        for (i = 0; i < 12; i++)
        {
            if (!(gUnknown_0203AB88->var08 & gUnknown_085B62E4[i].var04))
                gSprites[gUnknown_0203AB88->var3C[i + 29]].invisible = 0;
...
static void sub_8142F7C(void)
{
    ...
    for (i = 0; i < 6; i++)
    {
        ...
        gSprites[gUnknown_0203AB88->var3C[i + 49]].invisible = 1;
...
static void sub_8143038(u8 r0, u8 r1)
{
    ...
    else
    {
        for ( ; i < 6; i++)
        {
            ...
            {
                gSprites[gUnknown_0203AB88->var3C[i + 49]].invisible = 0;
...
static void sub_8143150(u8 r0)
{
    ...
    {
        gSprites[gUnknown_0203AB88->var3C[48]].invisible = 0;
...
static void sub_8143314(void)
{
    ...
    gSprites[gUnknown_0203AB88->var3C[20]].animPaused = 1;
    for (i = 0; i < 4; i++)
    {
        gUnknown_0203AB88->var3C[i + 21] = CreateSprite(&gUnknown_085B77FC, i * 8 + 196, 24, 0);
        gSprites[gUnknown_0203AB88->var3C[i + 21]].invisible = 1;
        gSprites[gUnknown_0203AB88->var3C[i + 21]].animPaused = 1;
    }
    gUnknown_0203AB88->var3C[25] = CreateSprite(&gUnknown_085B7814, 120, 68, 4);
    gSprites[gUnknown_0203AB88->var3C[25]].animPaused = 1;
    for (i = 0; i < 3; i++)
    {
        gUnknown_0203AB88->var3C[i + 26] = CreateSprite(&gUnknown_085B782C, i * 16 + 192, 36, 4);
        gSprites[gUnknown_0203AB88->var3C[i + 26]].invisible = 1;
        gSprites[gUnknown_0203AB88->var3C[i + 26]].animPaused = 1;
    }
    gUnknown_0203AB88->var3C[48] = CreateSprite(&gUnknown_085B7844, 152, 96, 9);
    gSprites[gUnknown_0203AB88->var3C[48]].oam.priority = 1;
    gSprites[gUnknown_0203AB88->var3C[48]].animPaused = 1;
    gSprites[gUnknown_0203AB88->var3C[48]].invisible = 1;
}
...
static void sub_8143514(u16 r0)
{
    ...
    for (i = 0; i < 4; i++)
    {
        ...
        if (t > 0 || v || i == 3)
        {
            gSprites[gUnknown_0203AB88->var3C[i + 21]].invisible = 0;
...
static void sub_814372C(u8 r0)
{
    ...
    case 6:
        for (i = 0; i < 3; i++)
        {
            gSprites[gUnknown_0203AB88->var3C[i + 26]].invisible = 0;
...
static void sub_81439C8(void)
{
    ...
    for (i = 0; i < 6; i++)
    {
        ...
        if (gUnknown_0203AB88->var3C[i] != 64)
        {
            gSprites[gUnknown_0203AB88->var3C[i]].invisible = 1;
            gSprites[gUnknown_0203AB88->var3C[i]].coordOffsetEnabled = 1;
        }
    }
}
...
static void sub_81446DC(struct Sprite *sprite)
{
    ...
    for (i = 0; i < 3; i++)
    {
        gSprites[gUnknown_0203AB88->var3C[i + 55]].coordOffsetEnabled = 0;
        gSprites[gUnknown_0203AB88->var3C[i + 55]].invisible = 1;
        gSprites[gUnknown_0203AB88->var3C[i + 55]].animPaused = 1;
        gSprites[gUnknown_0203AB88->var3C[i + 55]].affineAnimPaused = 1;
    ...
    gSprites[gUnknown_0203AB88->var3C[56]].coordOffsetEnabled = 1;
...
static void sub_81448B8(struct Sprite *sprite)
{
    ...
    gSprites[gUnknown_0203AB88->var3C[56]].affineAnimPaused = 1;
    gSprites[gUnknown_0203AB88->var3C[56]].animPaused = 1;
...
static void sub_8144CD0(struct Sprite *sprite)
{
    ...
    {
        gSpriteCoordOffsetY = 0;
        gSprites[gUnknown_0203AB88->var3C[55]].animPaused = 0;
        DestroySprite(sprite);
    }
}
