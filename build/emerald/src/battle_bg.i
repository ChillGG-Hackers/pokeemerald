...
void DrawMainBattleBackground(void)
{
    if (gBattleTypeFlags & (0x0002 | (0x0100 | 0x10000 | 0x20000 | 0x40000 | 0x80000 | 0x100000 | 0x200000) | 0x0800 | 0x2000000))
    {
    ...
    else if (gBattleTypeFlags & 0x10000000)
    {
    ...
    else if (gBattleTypeFlags & 0x20000000)
    {
    ...
    else if (gBattleTypeFlags & 0x40000000)
    {
...
void DrawBattleEntryBackground(void)
{
    ...
    else if (gBattleTypeFlags & ((0x0100 | 0x10000 | 0x20000 | 0x40000 | 0x80000 | 0x100000 | 0x200000) | 0x0002 | 0x2000000 | 0x0800))
    {
...
bool8 LoadChosenBattleElement(u8 caseId)
{
    ...
    case 2:
        ...
        break;
    case 3:
        if (gBattleTypeFlags & ((0x0100 | 0x10000 | 0x20000 | 0x40000 | 0x80000 | 0x100000 | 0x200000) | 0x0002 | 0x2000000 | 0x0800))
        {
            LZDecompressVram(gBattleTerrainTiles_Building, (void*)((0x6000000 + (0x4000 * (2)))));
        }
        else if (gBattleTypeFlags & 0x10000000)
    ...
    case 4:
        ...
        else if (gBattleTypeFlags & 0x1000)
        {
            if (gGameVersion == 2)
                LZDecompressVram(gBattleTerrainTilemap_Cave, (void*)((0x6000000 + (0x800 * (26)))));
            else
