...
void PutPokemonTodayFailedOnTheAir(void)
{
    ...
    if (!TV_BernoulliTrial(0xFFFF * (1) / (1)))
    {
        ...
        if (ct > 2 && (gBattleOutcome == 0x6 || gBattleOutcome == 0x1))
        {
            sCurTVShowSlot = FindEmptyTVSlotBeyondFirstFiveShowsOfArray(gSaveBlock1Ptr->tvShows);
...
static void InterviewAfter_ContestLiveUpdates(void)
{
    ...
    if (show->contestLiveUpdates.kind == 8)
    {
        ...
        show2->contestLiveUpdates.species = GetMonData(&gPlayerParty[gContestMonPartyIndex], 11, ((void *)0));
...
void ContestLiveUpdates_BeforeInterview_5(u8 a0, u8 a1)
{
    ...
    if (sCurTVShowSlot != -1)
    {
        ...
        else if (gGameLanguage == 1 || gLinkPlayers[a1].language == 1)
        {
            show->contestLiveUpdates.winningTrainerLanguage = 1;
        }
        else
        {
...
void DeleteTVShowInArrayByIdx(TVShow *shows, u8 idx)
{
    ...
    shows[idx].common.kind = 0;
    shows[idx].common.active = 0;
    for (i = 0; i < 34; i ++)
    {
...
void ChangePokemonNickname(void)
{
    ...
    DoNamingScreen(3, gStringVar2, GetMonData(&gPlayerParty[gSpecialVar_0x8004], 11, ((void *)0)), GetMonGender(&gPlayerParty[gSpecialVar_0x8004]), GetMonData(&gPlayerParty[gSpecialVar_0x8004], 0, ((void *)0)), ChangePokemonNickname_CB);
}
...
void ChangeBoxPokemonNickname(void)
{
    ...
    DoNamingScreen(3, gStringVar2, GetBoxMonData(boxMon, 11, ((void *)0)), GetBoxMonGender(boxMon), GetBoxMonData(boxMon, 0, ((void *)0)), ChangeBoxPokemonNickname_CB);
}
...
# 3930 "src/tv.c"
__attribute__((naked)) static void sub_80F0708(void)
{
