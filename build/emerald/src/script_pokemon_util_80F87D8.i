# 1 "src/script_pokemon_util_80F87D8.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "src/script_pokemon_util_80F87D8.c"
...
# 2 "src/script_pokemon_util_80F87D8.c" 2
...
# 3 "src/script_pokemon_util_80F87D8.c" 2
# 1 "include/battle_gfx_sfx_util.h" 1
# 4 "src/script_pokemon_util_80F87D8.c" 2
# 1 "include/berry.h" 1
...
# 5 "src/script_pokemon_util_80F87D8.c" 2
...
# 6 "src/script_pokemon_util_80F87D8.c" 2
...
# 7 "src/script_pokemon_util_80F87D8.c" 2
...
# 8 "src/script_pokemon_util_80F87D8.c" 2
# 1 "include/data.h" 1
...
# 9 "src/script_pokemon_util_80F87D8.c" 2
...
# 10 "src/script_pokemon_util_80F87D8.c" 2
...
# 11 "src/script_pokemon_util_80F87D8.c" 2
...
# 12 "src/script_pokemon_util_80F87D8.c" 2
...
# 13 "src/script_pokemon_util_80F87D8.c" 2
...
# 14 "src/script_pokemon_util_80F87D8.c" 2
# 1 "include/link.h" 1
# 98 "include/link.h"
struct LinkStatus
{
...
# 15 "src/script_pokemon_util_80F87D8.c" 2
...
bool32 sub_800E540(u16 id, u8 *name);
void WipeTrainerNameRecords(void);
# 16 "src/script_pokemon_util_80F87D8.c" 2
# 1 "include/main.h" 1
# 17 "src/script_pokemon_util_80F87D8.c" 2
# 1 "include/menu.h" 1
# 18 "src/script_pokemon_util_80F87D8.c" 2
...
# 19 "src/script_pokemon_util_80F87D8.c" 2
# 1 "include/palette.h" 1
# 20 "src/script_pokemon_util_80F87D8.c" 2
...
# 21 "src/script_pokemon_util_80F87D8.c" 2
...
# 22 "src/script_pokemon_util_80F87D8.c" 2
# 1 "include/pokemon.h" 1
# 23 "src/script_pokemon_util_80F87D8.c" 2
...
# 24 "src/script_pokemon_util_80F87D8.c" 2
...
# 25 "src/script_pokemon_util_80F87D8.c" 2
...
# 26 "src/script_pokemon_util_80F87D8.c" 2
...
# 28 "src/script_pokemon_util_80F87D8.c" 2
# 1 "include/tv.h" 1
...
# 29 "src/script_pokemon_util_80F87D8.c" 2
# 1 "include/constants/event_objects.h" 1
# 30 "src/script_pokemon_util_80F87D8.c" 2
# 1 "include/constants/items.h" 1
# 31 "src/script_pokemon_util_80F87D8.c" 2
# 1 "include/constants/species.h" 1
# 32 "src/script_pokemon_util_80F87D8.c" 2
# 1 "include/constants/tv.h" 1
# 33 "src/script_pokemon_util_80F87D8.c" 2
# 1 "include/constants/vars.h" 1
# 34 "src/script_pokemon_util_80F87D8.c" 2
# 1 "include/constants/battle_frontier.h" 1
# 35 "src/script_pokemon_util_80F87D8.c" 2
...
{
# 236 "src/script_pokemon_util_80F87D8.c"
    ...
    if (FindTaskIdByFunc(Task_ShowContestEntryMonPic) == 0xFF)
    {
        ...
        if (gLinkContestFlags & (1 << 0))
        {
            if (!(gLinkContestFlags & (1 << 2)))
                DoMonFrontSpriteAnimation(&gSprites[spriteId], species, 0, 0);
        }
        else
        {
            DoMonFrontSpriteAnimation(&gSprites[spriteId], species, 0, 0);
...
static bool8 CheckPartyMonHasHeldItem(u16 item)
{
    ...
    for(i = 0; i < 6; i++)
    {
        ...
        if (species != 0 && species != 412 && GetMonData(&gPlayerParty[i], 12) == item)
            return 1;
    }
    return 0;
}
...
{
    bool8 hasItem = CheckPartyMonHasHeldItem(175);
    if (hasItem == 1)
