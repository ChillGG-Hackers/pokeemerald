...
u32 sub_81CDE94(s32 state)
{
    ...
    case 0:
        ...
        return 0;
    case 1:
        InitBgTemplates(gUnknown_08623358, (size_t)(sizeof(gUnknown_08623358) / sizeof((gUnknown_08623358)[0])));
        ChangeBgX(1, 0, 0);
        ChangeBgY(1, 0, 0);
        ChangeBgX(2, 0, 0);
        ChangeBgY(2, 0, 0);
    ...
    case 9:
        ...
        return 0;
    case 10:
        sub_81CE754(0, sub_81CDC84(), 1);
        return 0;
    case 11:
        sub_81CE754(1, sub_81CDC84(), 1);
        return 0;
    case 12:
        sub_81CE754(2, sub_81CDC84(), 1);
        return 0;
    case 13:
        if (sub_81CE754(3, sub_81CDC84(), 1) != 1)
            return 2;
    ...
    case 20:
        if (!sub_81D3178(sub_81CDC70(), &structPtr->unk1814))
        {
            ...
            if (sub_81CDD5C() == 1 || sub_81CDC60() != sub_81CDC50())
...
u32 sub_81CE37C(s32 state)
{
    ...
    case 4:
        ...
        return 2;
    case 5:
        sub_81CE754(0, sub_81CDC84(), 0);
        return 1;
    case 6:
        sub_81CE754(1, sub_81CDC84(), 0);
        return 1;
    case 7:
        sub_81CE754(2, sub_81CDC84(), 0);
        return 1;
    case 8:
        if (sub_81CE754(3, sub_81CDC84(), 0) == 1)
            return 1;
        return 2;
    case 9:
        unkPtr = sub_81CDC70();
...
bool32 sub_81CE754(u8 a0, u16 a1, bool8 a2)
{
    ...
    case 0:
        ...
        break;
    case 1:
        if (sub_81CDC60() != sub_81CDC50() - 1 || sub_81CDD5C() == 1)
        {
            str = sub_81CDD04(a1);
            AddTextPrinterParameterized(structPtr->unk1820, 1, str, 0, 1, 0, ((void *)0));
        }
        break;
    case 2:
        if (sub_81CDD5C() == 1)
        {
            str = sub_81CDD24(a1);
            AddTextPrinterParameterized(structPtr->unk1820, 1, str, 0, 17, 0, ((void *)0));
            text[0] = 0xFC;
            text[1] = 4;
            text[2] = 8;
            text[3] = 0;
            ...
            AddTextPrinterParameterized(structPtr->unk1821, 1, text, 4, 1, 0, ((void *)0));
            ConvertIntToDecimalStringN(text + 5, sub_81CDD48(), STR_CONV_MODE_RIGHT_ALIGN, 4);
            AddTextPrinterParameterized(structPtr->unk1821, 1, text, 28, 1, 0, ((void *)0));
        }
        break;
    case 3:
...
void sub_81CED30(u8 var)
{
    ...
    if (structPtr->unk1816 == 0xFF)
    {
        ...
        else
        {
            ...
            structPtr->unk181C = (void*)(0x6000000) + 0x10000 + (structPtr->unk181A * 32);
            structPtr->unk1818 = (structPtr->unk1818 * 16) + 0x100;
        }
    }
    else
    {
        { const void *_src = sub_81CDCB4(var); void *_dest = structPtr->unk181C; u32 _size = 0x800; { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(_src); dmaRegs[1] = (vu32)(_dest); dmaRegs[2] = (vu32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | ((_size)/(16/8))); dmaRegs[2]; }; };
