...
void CB2_ChooseStarter(void)
{
    ...
    InitBgsFromTemplates(0, gUnknown_085B1E00, (size_t)(sizeof(gUnknown_085B1E00) / sizeof((gUnknown_085B1E00)[0])));
...
static void Task_StarterChoose2(u8 taskId)
{
    ...
    if (gMain.newKeys & 0x0001)
    {
        ...
        spriteId = CreatePokemonFrontSprite(GetStarterPokemon(gTasks[taskId].data[0]), sPokeballCoords[selection][0], sPokeballCoords[selection][1]);
...
static void CreateStarterPokemonLabel(u8 selection)
{
    ...
    FillWindowPixelBuffer(sStarterChooseWindowId, ((0) | ((0) << 4)));
