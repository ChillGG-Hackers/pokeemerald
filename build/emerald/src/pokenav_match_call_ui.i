...
void sub_81C82E4(struct PokenavSub17 *a0)
{
    ...
    sub_8199DF0(a0->unk0.unk0.bg, ((1) | ((1) << 4)), a0->unk0.unk0.unk6, 1);
    sub_8199DF0(a0->unk0.unk0.bg, ((4) | ((4) << 4)), a0->unk0.unk0.unk6 + 1, 1);
...
void sub_81C835C(struct UnknownSubSubStruct_0203CF40 *a0)
{
    FillWindowPixelBuffer(a0->windowId, ((1) | ((1) << 4)));
...
u32 LoopedTask_sub_81C83F0(s32 state)
{
    ...
    case 0:
        ...
        AddTextPrinterParameterized(structPtr->unk0.windowId, structPtr->unk0.fontId, structPtr->unkTextBuffer, 8, (v1 << 4) + 1, 255, ((void *)0));
...
void sub_81C8CB4(struct MatchCallWindowState *a0, struct PokenavSub17Substruct *a1)
{
    ...
    FillWindowPixelRect(a1->unk0.windowId, ((4) | ((4) << 4)), 0, a1->unk0.unkA * 16, a1->unk0.unk4 * 8, 16);
    AddTextPrinterParameterized3(a1->unk0.windowId, a1->unk0.fontId, 8, (a1->unk0.unkA * 16) + 1, colors, 0xFF, a1->unkTextBuffer);
...
{
    a1->unk34(a0->unk10 + a0->unkC * a0->windowTopIndex, a1->unkTextBuffer);
    FillWindowPixelRect(a1->unk0.windowId, ((1) | ((1) << 4)), 0, a1->unk0.unkA * 16, a1->unk0.unk4 * 8, 16);
    AddTextPrinterParameterized(a1->unk0.windowId, a1->unk0.fontId, a1->unkTextBuffer, 8, a1->unk0.unkA * 16 + 1, 0xFF, ((void *)0));
...
void PrintMatchCallFieldNames(struct PokenavSub17Substruct *a0, u32 fieldId)
{
    ...
    FillWindowPixelRect(a0->unk0.windowId, ((1) | ((1) << 4)), 0, top << 4, a0->unk0.unk4, 16);
...
static void PrintMatchCallFlavorText(struct MatchCallWindowState *a0, struct PokenavSub17Substruct *a1, u32 checkPageEntry)
{
    ...
    if (str != ((void *)0))
    {
        ...
        AddTextPrinterParameterized(a1->unk0.windowId, 7, str, 2, (r6 << 4) + 1, 0xFF, ((void *)0));
