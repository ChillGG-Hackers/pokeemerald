...
static u32 LoopedTask_OpenMenu(s32 state)
{
    ...
    {
    case 0:
        InitBgTemplates(gUnknown_08620194, (size_t)(sizeof(gUnknown_08620194) / sizeof((gUnknown_08620194)[0])));
...
static void sub_81C9FC4(void)
{
    ...
    for (i = 0; i < (sizeof(gUnknown_086201C4)/sizeof(*(gUnknown_086201C4))); i++)
...
static void sub_81CA20C(void)
{
    ...
    for (i = 0; i < 6; i++)
    {
        if (unk->iconVisible[i])
        {
            ...
            sub_81CA448(unk->iconSprites[i], 0);
        }
        else
            sub_81CA448(unk->iconSprites[i], 1);
    }
}
