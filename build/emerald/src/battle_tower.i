...
const struct BattleFrontierTrainer gBattleFrontierTrainers[300] =
{
    ...
    [139] = {
        .facilityClass = 0xd,
        .trainerName = _("SOFIA"),
        .speechBefore = {((0x0 << 9) | 371), (0x7 << 9) | 0x18, (0xa << 9) | 0x4, (0x8 << 9) | 0x20, ((0x12 << 9) | 230), 0xFFFF},
    ...
    [219] = {
        .facilityClass = 0x2,
        .trainerName = _("TESS"),
        .speechBefore = {(0x9 << 9) | 0x36, (0x5 << 9) | 0x4a, ((0x0 << 9) | 367), (0xd << 9) | 0x22, (0xd << 9) | 0x4, (0x6 << 9) | 0x3},
...
const struct BattleFrontierTrainer gSlateportBattleTentTrainers[30] =
{
    ...
    [6] = {
        ...
        .speechBefore = {(0x3 << 9) | 0x1, (0x1 << 9) | 0xf, (0x8 << 9) | 0x20, ((0x0 << 9) | 324), (0x8 << 9) | 0x2b, (0x5 << 9) | 0x14},
        .speechWin = {(0x6 << 9) | 0x3b, (0x5 << 9) | 0x2, (0x8 << 9) | 0x17, (0x8 << 9) | 0x1e, (0x8 << 9) | 0x20, ((0x0 << 9) | 324)},
        .speechLose = {(0xb << 9) | 0x11, (0x5 << 9) | 0x1, (0xa << 9) | 0xf, (0x8 << 9) | 0x20, ((0x0 << 9) | 324), (0xa << 9) | 0x44},
    ...
    [13] = {
        ...
        .speechWin = {((0x0 << 9) | 320), (0x6 << 9) | 0x4, (0xf << 9) | 0x2, ((0x0 << 9) | 379), (0x6 << 9) | 0x0, -1},
        .speechLose = {((0x0 << 9) | 320), (0x6 << 9) | 0x4, (0xf << 9) | 0x2, ((0x15 << 9) | 143), (0x6 << 9) | 0x4, (0x6 << 9) | 0x9},
...
void DoSpecialTrainerBattle(void)
{
    ...
    {
    case 0:
        gBattleTypeFlags = 0x0008 | 0x0100;
        ...
        case 1:
            ...
            gBattleTypeFlags |= 0x0001;
            break;
        case 2:
            FillFrontierTrainersParties(2);
            gPartnerTrainerId = gSaveBlock2Ptr->frontier.trainerIds[17];
            FillPartnerParty(gPartnerTrainerId);
            gBattleTypeFlags |= 0x0001 | 0x400000 | 0x0040 | 0x8000;
            break;
        case 3:
            gBattleTypeFlags |= 0x0001 | 0x0002 | 0x0040 | 0x800000;
            FillFrontierTrainersParties(2);
            break;
        }
    ...
    case 2:
        ...
        gBattleTypeFlags = 0x0008 | 0x0800;
        gTrainerBattleOpponent_A = 0;
        CreateTask(Task_StartBattleAfterTransition, 1);
        PlayMapChosenOrBattleBGM(0);
        ...
        break;
    case 3:
        gBattleTypeFlags = 0x0008 | 0x10000;
        if (VarGet(0x40CE) == 1)
            gBattleTypeFlags |= 0x0001;
        ...
        break;
    case 4:
        gBattleTypeFlags = 0x0008 | 0x20000;
        if (VarGet(0x40CE) == 1)
            gBattleTypeFlags |= 0x0001;
        if (gSaveBlock2Ptr->frontier.lvlMode != 2)
            FillFrontierTrainerParty(3);
        ...
        break;
    case 5:
        gBattleTypeFlags = 0x0008 | 0x40000;
        if (gSaveBlock2Ptr->frontier.lvlMode != 2)
            FillFrontierTrainerParty(3);
        else
            FillTentTrainerParty(3);
        ...
        break;
    case 6:
        gBattleTypeFlags = 0x0008 | 0x80000;
        if (VarGet(0x40CE) == 1)
            gBattleTypeFlags |= 0x0001;
    ...
    case 7:
        ...
        break;
    case 10:
        gBattleTypeFlags = 0x0008 | 0x200000;
        FillFrontierTrainerParty(3);
        CreateTask(Task_StartBattleAfterTransition, 1);
        PlayMapChosenOrBattleBGM(0);
        ...
        break;
    case 9:
        gBattleTypeFlags = 0x0008 | 0x0100 | 0x0001 | 0x8000;
        ...
        break;
    case 8:
        gBattleTypeFlags = 0x0008 | 0x0001 | 0x8000 | 0x0040 | 0x400000;
...
static void sub_81646BC(u16 trainerId, u16 monId)
{
    ...
    if (trainerId != 500)
    {
        ...
        {
            move = gSaveBlock2Ptr->frontier.towerRecords[trainerId - 300].party[gUnknown_03006298[gSpecialVar_0x8005 + 1]].moves[0];
            species = gSaveBlock2Ptr->frontier.towerRecords[trainerId - 300].party[gUnknown_03006298[gSpecialVar_0x8005 + 1]].species;
        }
        else
        {
            s32 i;

            move = gSaveBlock2Ptr->apprentices[trainerId - 400].party[gUnknown_03006298[gSpecialVar_0x8005 - 1]].moves[0];
            species = gSaveBlock2Ptr->apprentices[trainerId - 400].party[gUnknown_03006298[gSpecialVar_0x8005 - 1]].species;
            for (i = 0; i < 7; i++)
...
s32 GetHighestLevelInPlayerParty(void)
{
    ...
    for (i = 0; i < 6; i++)
    {
        if (GetMonData(&gPlayerParty[i], 11, ((void *)0))
            && GetMonData(&gPlayerParty[i], 65, ((void *)0)) != 412)
        {
