...
static const struct MultichoiceListStruct sMultichoiceLists[] =
{
    ...
    [41] = {MultichoiceList_Exit, (size_t)(sizeof(MultichoiceList_Exit) / sizeof((MultichoiceList_Exit)[0]))},
...
static void CreateLilycoveSSTidalMultichoice(void)
{
    ...
    if (CheckBagHasItem(275, 1) == 1 && FlagGet((((0x500 + 864 - 1) + 1) + 0x53)) == 1)
    {
        if (gSpecialVar_0x8004 == 0)
        {
    ...
    if (CheckBagHasItem(370, 1) == 1 && FlagGet((((0x500 + 864 - 1) + 1) + 0x80)) == 1)
    {
        if (gSpecialVar_0x8004 == 0)
        {
    ...
    if (CheckBagHasItem(371, 1) == 1 && FlagGet((((0x500 + 864 - 1) + 1) + 0x75)) == 1)
    {
        if (gSpecialVar_0x8004 == 0)
        {
    ...
    if (CheckBagHasItem(376, 1) == 1 && FlagGet((((0x500 + 864 - 1) + 1) + 0x76)) == 1)
    {
        if (gSpecialVar_0x8004 == 0)
        {
...
static void CreateStartMenuForPokenavTutorial(void)
{
    ...
    sub_81983AC(windowId, 1, 0, 9, 16, (size_t)(sizeof(MultichoiceList_ForcedStartMenu) / sizeof((MultichoiceList_ForcedStartMenu)[0])), 0);
