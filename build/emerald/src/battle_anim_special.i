...
# 20 "src/battle_anim_special.c" 2
# 1 "include/constants/moves.h" 1
# 21 "src/battle_anim_special.c" 2
# 1 "include/constants/songs.h" 1
# 22 "src/battle_anim_special.c" 2
# 1 "include/constants/rgb.h" 1
# 23 "src/battle_anim_special.c" 2
...
# 120 "src/battle_anim_special.c"
const struct CompressedSpriteSheet gBallParticleSpritesheets[] =
{
    {gBattleAnimSpriteGfx_Particles, 0x100, 55020},
    {gBattleAnimSpriteGfx_Particles, 0x100, 55021},
    {gBattleAnimSpriteGfx_Particles, 0x100, 55022},
    {gBattleAnimSpriteGfx_Particles, 0x100, 55023},
    {gBattleAnimSpriteGfx_Particles, 0x100, 55024},
    {gBattleAnimSpriteGfx_Particles, 0x100, 55025},
    {gBattleAnimSpriteGfx_Particles, 0x100, 55026},
    {gBattleAnimSpriteGfx_Particles, 0x100, 55027},
    {gBattleAnimSpriteGfx_Particles, 0x100, 55028},
    {gBattleAnimSpriteGfx_Particles, 0x100, 55029},
    {gBattleAnimSpriteGfx_Particles, 0x100, 55030},
    {gBattleAnimSpriteGfx_Particles, 0x100, 55031},
};

const struct CompressedSpritePalette gBallParticlePalettes[] =
{
    {gBattleAnimSpritePal_CircleImpact, 55020},
    {gBattleAnimSpritePal_CircleImpact, 55021},
    {gBattleAnimSpritePal_CircleImpact, 55022},
    {gBattleAnimSpritePal_CircleImpact, 55023},
    {gBattleAnimSpritePal_CircleImpact, 55024},
    {gBattleAnimSpritePal_CircleImpact, 55025},
    {gBattleAnimSpritePal_CircleImpact, 55026},
    {gBattleAnimSpritePal_CircleImpact, 55027},
    {gBattleAnimSpritePal_CircleImpact, 55028},
    {gBattleAnimSpritePal_CircleImpact, 55029},
    {gBattleAnimSpritePal_CircleImpact, 55030},
    {gBattleAnimSpritePal_CircleImpact, 55031},
};
...
void AnimTask_ThrowBallSpecial(u8 taskId)
{
    ...
    gSprites[gBattlerSpriteIds[GetBattlerAtPosition(0)]].callback = sub_8039E84;
    gTasks[taskId].data[0] = spriteId;
...
static void sub_8171520(struct Sprite *sprite)
{
    ...
    case 5:
        ...
        {
            if (gBattleSpritesDataPtr->animationData->ballThrowCaseId == 4 && state == 3)
            {
...
static void DestroyBallOpenAnimationParticle(struct Sprite *sprite)
{
    ...
    else
    {
        ...
        if (gBattleSpritesDataPtr->animationData->field_A == 0)
        {
            for (i = 0; i < POKEBALL_COUNT; i++)
            {
                if (FuncIsActiveTask(gBallParticleAnimationFuncs[i]) == 1)
                    break;
            }
...
static void sub_817330C(struct Sprite *sprite)
{
    ...
    sprite->data[0] = 30;
    sprite->data[2] = GetBattlerSpriteCoord(GetBattlerAtPosition(1), 0) + gBattleAnimArgs[2];
    sprite->data[4] = GetBattlerSpriteCoord(GetBattlerAtPosition(1), 1) + gBattleAnimArgs[3];
    sprite->data[5] = -32;
    InitAnimArcTranslation(sprite);
