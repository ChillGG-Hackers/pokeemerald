...
static void RecordedPlayerBufferRunCommand(void)
{
    ...
    {
        if (gBattleBufferA[gActiveBattler][0] < (size_t)(sizeof(sRecordedPlayerBufferCommands) / sizeof((sRecordedPlayerBufferCommands)[0])))
...
static void sub_8189D40(void)
{
    ...
    if (GetBattlerPosition(gActiveBattler) == 0)
    {
        ...
        if (!gBattleSpritesDataPtr->healthBoxesData[gActiveBattler ^ 2].flag_x80
