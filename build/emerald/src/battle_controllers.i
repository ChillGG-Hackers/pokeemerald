...
static void InitSinglePlayerBtlControllers(void)
{
    ...
    else
    {
        ...
        if (gBattleTypeFlags & 0x1000000)
        {
            ...
            else if (gBattleTypeFlags & 0x0004)
            {
                gBattlerControllerFuncs[0] = SetControllerToRecordedPlayer;
                gBattlerPositions[0] = 0;
...
static void InitLinkBtlControllers(void)
{
    ...
    else if (!(gBattleTypeFlags & 0x0040) && gBattleTypeFlags & 0x0001)
    {
        if (gBattleTypeFlags & 0x0004)
        {
            gBattleMainFunc = BeginBattleIntro;
                ...
                if (i < 2)
                {
                    if (((gBattlerPositions[i]) & 1) == 0)
                    {
                        if (GetMonData(&gPlayerParty[j], 57) != 0
                         ...
                         && GetMonData(&gPlayerParty[j], 65) != 412
                    ...
                    else
                    {
                        if (GetMonData(&gEnemyParty[j], 57) != 0
                         ...
                         && GetMonData(&gEnemyParty[j], 65) != 412
    ...
    case 2:
        ...
        else
        {
            if (gBattleTypeFlags & 0x0100)
                ...
                var = (gBattleTypeFlags & 0x0040) ? 4 : 2;
...
void sub_8033648(void)
{
    ...
    if (gReceivedRemoteLinkPlayers != 0 && (gBattleTypeFlags & 0x0020))
    {
        sub_8011BD0();
