...
# 2 "src/rom_81520A8.c" 2
# 1 "include/rom_81520A8.h" 1
...
# 6 "src/rom_81520A8.c" 2

static __attribute__((section("ewram_data"))) struct
{
    u8 count;
    struct UnkStruct_81520A8 *unk4;
} *sUnknown_0203ABB8 = ((void *)0);

void sub_81520A8(void *dest, u16 value, u8 left, u8 top, u8 width, u8 height)
{
    u8 i;
    u8 j;
    u8 x;
...
void sub_8152134(void *dest, const u16 *src, u8 left, u8 top, u8 width, u8 height)
{
    u8 i;
    u8 j;
    u8 x;
...
bool32 sub_81521C0(u8 count)
{
    ...
    if (sUnknown_0203ABB8 == ((void *)0))
        return 0;
    sUnknown_0203ABB8->unk4 = AllocZeroed(count * sizeof(struct UnkStruct_81520A8));
    if (sUnknown_0203ABB8->unk4 == ((void *)0))
    {
        { Free(sUnknown_0203ABB8); sUnknown_0203ABB8 = ((void *)0); };
        return 0;
    }
    ...
    for (i = 0; i < count; i++)
    {
        ...
        sUnknown_0203ABB8->unk4[i].unk19_2 = 1;
    }
...
bool32 sub_8152254(void)
{
    ...
    { Free(sUnknown_0203ABB8->unk4); sUnknown_0203ABB8->unk4 = ((void *)0); };
...
bool32 sub_81522D4(void)
{
    ...
    if (sUnknown_0203ABB8 == ((void *)0) || sUnknown_0203ABB8->unk4 == ((void *)0))
        return 0;
    ...
    for (i = 0; i < sUnknown_0203ABB8->count; i++)
    {
        ...
        {
            if (sUnknown_0203ABB8->unk4[i].callback != ((void *)0))
...
u8 sub_8152438(u8 id, void (*func)(struct UnkStruct_81520A8 *))
{
    if (sUnknown_0203ABB8 == ((void *)0) || id >= sUnknown_0203ABB8->count)
        return 0xFF;
...
u8 sub_8152474(u8 id, u8 dataArrayId, s16 dataValue)
{
    if (sUnknown_0203ABB8 == ((void *)0) || id >= sUnknown_0203ABB8->count)
        return 0xFF;
    else if (!sUnknown_0203ABB8->unk4[id].unk19_0 || dataArrayId >= (size_t)(sizeof(sUnknown_0203ABB8->unk4[id].data) / sizeof((sUnknown_0203ABB8->unk4[id].data)[0])))
        return 0xFF;
...
u8 sub_81524C4(const struct OamData *oam, u16 tileTag, u16 palTag, s16 x, s16 y, u8 arg5, u8 priority)
{
    struct UnkStruct_81520A8 *structPtr = ((void *)0);
    u8 i;

    if (sUnknown_0203ABB8 == ((void *)0) || oam == ((void *)0))
        return 0xFF;
...
u8 sub_81525D0(u8 id)
{
    if (sUnknown_0203ABB8 == ((void *)0) || !sUnknown_0203ABB8->unk4[id].unk19_0)
        return 0xFF;
    ...
    sUnknown_0203ABB8->unk4[id].unk19_2 = 1;
