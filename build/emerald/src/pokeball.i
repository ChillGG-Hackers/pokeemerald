...
static void SpriteCB_ReleaseMonFromBall(struct Sprite *sprite)
{
    ...
    if (GetBattlerSide(sprite->data[6]) == 1)
        gSprites[gBattlerSpriteIds[sprite->data[6]]].callback = sub_8039B58;
    else
        gSprites[gBattlerSpriteIds[sprite->data[6]]].callback = sub_8039E44;
...
static void sub_80765E0(struct Sprite *sprite)
{
    ...
    {
        if (gSprites[monSpriteId].data[7] == 412)
