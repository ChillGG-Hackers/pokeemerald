...
# 11 "src/unk_transition.c" 2
# 1 "include/constants/rgb.h" 1
# 12 "src/unk_transition.c" 2
...
void Phase2Task_34(u8 taskId)
{
    while (sPhase2_34_Funcs[gTasks[taskId].data[0]](&gTasks[taskId]));
}
...
void Phase2Task_35(u8 taskId)
{
    while (sPhase2_35_Funcs[gTasks[taskId].data[0]](&gTasks[taskId]));
}
...
void Phase2Task_36(u8 taskId)
{
    while (sPhase2_36_Funcs[gTasks[taskId].data[0]](&gTasks[taskId]));
}
...
void Phase2Task_37(u8 taskId)
{
    while (sPhase2_37_Funcs[gTasks[taskId].data[0]](&gTasks[taskId]));
}
...
void Phase2Task_38(u8 taskId)
{
    while (sPhase2_38_Funcs[gTasks[taskId].data[0]](&gTasks[taskId]));
}
...
void Phase2Task_39(u8 taskId)
{
    while (sPhase2_39_Funcs[gTasks[taskId].data[0]](&gTasks[taskId]));
}
...
void Phase2Task_40(u8 taskId)
{
    while (sPhase2_40_Funcs[gTasks[taskId].data[0]](&gTasks[taskId]));
}
...
void Phase2Task_41(u8 taskId)
{
    while (sPhase2_41_Funcs[gTasks[taskId].data[0]](&gTasks[taskId]));
}
