...
__attribute__((section("ewram_data"))) static u8 sUnknown_020322D8 = 0;
...
__attribute__((section("ewram_data"))) static struct WarpData gFixedDiveWarp = {0};
__attribute__((section("ewram_data"))) static struct WarpData gFixedHoleWarp = {0};
__attribute__((section("ewram_data"))) static u16 sLastMapSectionId = 0;
__attribute__((section("ewram_data"))) static struct InitialPlayerAvatarState gInitialPlayerAvatarState = {0};
...
void SetWarpDestinationToFixedHoleWarp(s16 x, s16 y)
{
    if (IsDummyWarp(&gFixedHoleWarp) == 1)
...
void ResetInitialPlayerAvatarState(void)
{
    ...
    gInitialPlayerAvatarState.transitionFlags = (1 << PLAYER_AVATAR_STATE_NORMAL);
}
...
void StoreInitialPlayerAvatarState(void)
{
    ...
    if (TestPlayerAvatarFlags((1 << PLAYER_AVATAR_STATE_MACH_BIKE)))
        gInitialPlayerAvatarState.transitionFlags = (1 << PLAYER_AVATAR_STATE_MACH_BIKE);
    else if (TestPlayerAvatarFlags((1 << PLAYER_AVATAR_STATE_ACRO_BIKE)))
        gInitialPlayerAvatarState.transitionFlags = (1 << PLAYER_AVATAR_STATE_ACRO_BIKE);
    else if (TestPlayerAvatarFlags((1 << PLAYER_AVATAR_STATE_SURFING)))
        gInitialPlayerAvatarState.transitionFlags = (1 << PLAYER_AVATAR_STATE_SURFING);
    else if (TestPlayerAvatarFlags((1 << PLAYER_AVATAR_STATE_UNDERWATER)))
        gInitialPlayerAvatarState.transitionFlags = (1 << PLAYER_AVATAR_STATE_UNDERWATER);
    else
        gInitialPlayerAvatarState.transitionFlags = (1 << PLAYER_AVATAR_STATE_NORMAL);
}
