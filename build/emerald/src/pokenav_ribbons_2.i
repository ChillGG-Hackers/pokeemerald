...
u32 sub_81D04C4(struct PokenavSub13 *structPtr)
{
    if (gMain.newAndRepeatedKeys & 0x0040 && structPtr->field_8->unk2 != 0)
    {
    ...
    else if (gMain.newAndRepeatedKeys & 0x0080 && structPtr->field_8->unk2 < structPtr->field_8->unk0 - 1)
    {
        structPtr->field_8->unk2++;
        structPtr->field_C = 0;
        sub_81D0814(structPtr);
...
u32 sub_81D0548(struct PokenavSub13 *structPtr)
{
    if (gMain.newAndRepeatedKeys & 0x0040 && sub_81D05DC(structPtr))
        return 3;
    else if (gMain.newAndRepeatedKeys & 0x0080 && sub_81D061C(structPtr))
        return 3;
    else if (gMain.newAndRepeatedKeys & 0x0020 && sub_81D0664(structPtr))
        return 3;
    else if (gMain.newAndRepeatedKeys & 0x0010 && sub_81D0688(structPtr))
        return 3;
    else if (gMain.newKeys & 0x0002)
    {
        structPtr->field_98 = sub_81D04C4;
...
void sub_81D0E84(struct PokenavSub14 *structPtr)
{
    ...
    FillWindowPixelBuffer(structPtr->field_A, ((4) | ((4) << 4)));
...
void sub_81D10A4(struct PokenavSub14 *structPtr)
{
    ...
    FillWindowPixelBuffer(structPtr->field_C, ((1) | ((1) << 4)));
...
void sub_81D10D0(struct PokenavSub14 *structPtr)
{
    ...
    *(txtPtr++) = 0xBA;
    ...
    AddTextPrinterParameterized(structPtr->field_C, 1, gStringVar1, x, 1, 0xFF, ((void *)0));
