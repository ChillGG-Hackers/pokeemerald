...
__attribute__((section("ewram_data"))) struct UnkStruct_2022C6C * gUnknown_02022C6C = ((void *)0);
...
void sub_801A43C(void)
{
    ...
    InitBgsFromTemplates(0, gUnknown_082F0D34, (size_t)(sizeof(gUnknown_082F0D34) / sizeof((gUnknown_082F0D34)[0])));
...
u32 sub_801A960(struct UnkStruct_x20 * a0, u32 * a1)
{
    ...
    for (i = 0; i < (unsigned)(size_t)(sizeof(gUnknown_082F0D70) / sizeof((gUnknown_082F0D70)[0])); i++)
    {
