...
static void OpponentBufferRunCommand(void)
{
    ...
    {
        if (gBattleBufferA[gActiveBattler][0] < (size_t)(sizeof(sOpponentBufferCommands) / sizeof((sOpponentBufferCommands)[0])))
...
static void sub_805F2F0(void)
{
    ...
    if (!IsDoubleBattle() || ((IsDoubleBattle() && (gBattleTypeFlags & 0x0040)) || (gBattleTypeFlags & 0x8000)))
    {
    ...
    if (var)
    {
        if (var2 == 1)
        {
            if (var2 && gBattleSpritesDataPtr->healthBoxesData[gActiveBattler].field_1_x1 && gBattleSpritesDataPtr->healthBoxesData[gActiveBattler ^ 2].field_1_x1)
            {
                ...
                gBattleSpritesDataPtr->healthBoxesData[gActiveBattler ^ 2].flag_x80 = 0;
                gBattleSpritesDataPtr->healthBoxesData[gActiveBattler ^ 2].field_1_x1 = 0;
        ...
        else if (gBattleSpritesDataPtr->healthBoxesData[gActiveBattler].field_1_x1)
        {
            ...
            {
                if (gBattleSpritesDataPtr->healthBoxesData[gActiveBattler ^ 2].flag_x80 == 0 && gBattleSpritesDataPtr->healthBoxesData[gActiveBattler ^ 2].field_1_x1 == 0)
                {
                    FreeSpriteTilesByTag(0x27F9);
                    FreeSpritePaletteByTag(0x27F9);
                }
...
static void sub_805F560(void)
{
    ...
    if (!(gBattleTypeFlags & 0x8000) && !(gBattleTypeFlags & 0x0040) && IsDoubleBattle() && !gBattleSpritesDataPtr->healthBoxesData[gActiveBattler ^ 2].flag_x80 && !gBattleSpritesDataPtr->healthBoxesData[gActiveBattler ^ 2].ballAnimActive && !gBattleSpritesDataPtr->healthBoxesData[gActiveBattler ^ 2].field_1_x1)
        sub_8172EF0(gActiveBattler ^ 2, &gEnemyParty[gBattlerPartyIndexes[gActiveBattler ^ 2]]);
        ...
        && !IsCryPlayingOrClearCrySongs())
    {
        ...
        {
            if (gBattleTypeFlags & 0x0040 && gBattleTypeFlags & 0x0002)
            {
...
static void OpponentHandleDrawTrainerPic(void)
{
    ...
    {
        if (gBattleTypeFlags & (0x8000 | 0x800000))
        {
            if (gActiveBattler == 1)
    ...
    if (gBattleTypeFlags & (0x0040 | 0x8000))
    {
...
static void OpponentHandleChooseMove(void)
{
    ...
    else
    {
        ...
        if (gBattleTypeFlags & (0x0008 | 0x0010 | 0x0080 | 0x0400))
        {
