...
bool8 gUnknown_030030EC[4];
bool8 gUnknown_030030F0[4];
...
__attribute__((section("ewram_data"))) u32 gUnknown_020223C0 = 0;
...
__attribute__((section("ewram_data"))) u16 gUnknown_02022B08 = 0;
__attribute__((section("ewram_data"))) void *gUnknown_02022B0C = ((void *)0);
...
__attribute__((aligned(4))) const u16 gWirelessLinkDisplayPal[] = INCBIN_U16("graphics/interface/wireless_link_display.gbapal");
...
static void InitLinkTestBG(u8 paletteNum, u8 bgNum, u8 screenBaseBlock, u8 charBaseBlock, u16 a4)
{
    ...
    { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(gLinkTestDigitsGfx); dmaRegs[1] = (vu32)((u16 *)(0x6000000 + (0x4000 * (charBaseBlock))) + (16 * a4)); dmaRegs[2] = (vu32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | ((sizeof gLinkTestDigitsGfx)/(16/8))); dmaRegs[2]; };
...
{
    LoadPalette(gLinkTestDigitsPal, paletteNum * 16, 0x20);
    { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(gLinkTestDigitsGfx); dmaRegs[1] = (vu32)((u16 *)(0x6000000 + (0x4000 * (charBaseBlock)))); dmaRegs[2] = (vu32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | ((sizeof gLinkTestDigitsGfx)/(16/8))); dmaRegs[2]; };
    gLinkTestBGInfo.screenBaseBlock = screenBaseBlock;
    gLinkTestBGInfo.paletteNum = paletteNum;
    gLinkTestBGInfo.dummy_8 = 0;
    SetGpuReg(gBGControlRegs[bgNum], ((screenBaseBlock) << 8) | ((charBaseBlock) << 2));
}
...
{
    if (GetLinkPlayerCount() != 4 || sub_8009FF8(2, 1) < 0)
    {
        return 0;
    }
    return 1;
...
void CB2_LinkError(void)
{
    ...
    gUnknown_02022B0C = tilemapBuffer = Alloc(0x800);
...
static void sub_800B080(void)
{
    ...
    DecompressAndLoadBgGfxUsingHeap(1, gWirelessLinkDisplayGfx, 0, 0, 0);
