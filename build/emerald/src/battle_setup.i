...
# 1 "include/script_pokemon_80F8.h" 1
...
void BattleSetup_StartLegendaryBattle(void)
{
    ...
    default:
    case 405:
        gBattleTypeFlags |= 0x10000000;
        CreateBattleStartTask(23, 480);
        break;
    case 404:
        gBattleTypeFlags |= 0x20000000;
        CreateBattleStartTask(22, 480);
        break;
    case 406:
        gBattleTypeFlags |= 0x40000000;
...
static u16 GetSumOfPlayerPartyLevel(u8 numMons)
{
    ...
    for (i = 0; i < 6; i++)
    {
        ...
        if (species != 412 && species != 0 && GetMonData(&gPlayerParty[i], 57) != 0)
        {
...
u8 sub_80B100C(s32 arg0)
{
    ...
    if (enemyLevel < playerLevel)
    {
        ...
        case 13:
            return 4;
        case 10:
            return sUnknown_0854FEA4[Random() % (size_t)(sizeof(sUnknown_0854FEA4) / sizeof((sUnknown_0854FEA4)[0]))];
        case 3:
            return sUnknown_0854FEA7[Random() % (size_t)(sizeof(sUnknown_0854FEA7) / sizeof((sUnknown_0854FEA7)[0]))];
        }

        if (VarGet(0x40CE) != 3)
            return sUnknown_0854FE98[Random() % (size_t)(sizeof(sUnknown_0854FE98) / sizeof((sUnknown_0854FE98)[0]))];
    }
    else
    {
        switch (arg0)
    ...
    return sUnknown_0854FE98[var % (size_t)(sizeof(sUnknown_0854FE98) / sizeof((sUnknown_0854FE98)[0]))];
}
...
void BattleSetup_StartTrainerBattle(void)
{
    if (gNoOfApproachingTrainers == 2)
        gBattleTypeFlags = (0x0001 | 0x8000 | 0x0008);
    else
