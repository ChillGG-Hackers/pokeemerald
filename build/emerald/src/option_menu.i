...
__attribute__((section("ewram_data"))) static bool8 sArrowPressed = 0;
...
static void HighlightOptionMenuItem(u8 index)
{
    ...
    SetGpuReg(0x44, (((index * 16 + 40) << 8) | (index * 16 + 56)));
}
...
static void DrawOptionMenuChoice(const u8 *text, u8 x, u8 y, u8 style)
{
    ...
    dst[i] = 0xFF;
    AddTextPrinterParameterized(WIN_OPTIONS, 1, dst, x, y + 1, 0xFF, ((void *)0));
}
...
static void TextSpeed_DrawChoices(u8 selection)
{
    ...
    DrawOptionMenuChoice(gText_TextSpeedFast, GetStringRightAlignXOffset(1, gText_TextSpeedFast, 198), (MENUITEM_TEXTSPEED * 16), styles[2]);
}
...
static void BattleScene_DrawChoices(u8 selection)
{
    ...
    DrawOptionMenuChoice(gText_BattleSceneOff, GetStringRightAlignXOffset(1, gText_BattleSceneOff, 198), (MENUITEM_BATTLESCENE * 16), styles[1]);
}
...
static void BattleStyle_DrawChoices(u8 selection)
{
    ...
    DrawOptionMenuChoice(gText_BattleStyleSet, GetStringRightAlignXOffset(1, gText_BattleStyleSet, 198), (MENUITEM_BATTLESTYLE * 16), styles[1]);
}
...
static void Sound_DrawChoices(u8 selection)
{
    ...
    DrawOptionMenuChoice(gText_SoundStereo, GetStringRightAlignXOffset(1, gText_SoundStereo, 198), (MENUITEM_SOUND * 16), styles[1]);
}
...
static void FrameType_DrawChoices(u8 selection)
{
    ...
    DrawOptionMenuChoice(text, 128, (MENUITEM_FRAMETYPE * 16), 1);
}
...
static void ButtonMode_DrawChoices(u8 selection)
{
    ...
    DrawOptionMenuChoice(gText_ButtonTypeLEqualsA, GetStringRightAlignXOffset(1, gText_ButtonTypeLEqualsA, 198), (MENUITEM_BUTTONMODE * 16), styles[2]);
}

static void DrawTextOption(void)
{
    FillWindowPixelBuffer(WIN_TEXT_OPTION, ((1) | ((1) << 4)));
    AddTextPrinterParameterized(WIN_TEXT_OPTION, 1, gText_Option, 8, 1, 0xFF, ((void *)0));
...
static void DrawOptionMenuTexts(void)
{
    ...
    {
        AddTextPrinterParameterized(WIN_OPTIONS, 1, sOptionMenuItemsNames[i], 8, (i * 16) + 1, 0xFF, ((void *)0));
    }
    CopyWindowToVram(WIN_OPTIONS, 3);
}
