...
void task_tutorial_controls_fadein(struct UnkStruct0 *r0)
{
    ...
    if (r0->var00)
    {
        for (i = 0; i < 16; i++)
        {
            if ((r0->var02 >> i) & 1)
            {
                if (--r0->var04[i].var01 == 0xFF)
                {
                    if (r0->var04[i].var04.var00 & 0x8000)
