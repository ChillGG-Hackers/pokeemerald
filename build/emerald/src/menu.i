...
static __attribute__((section("ewram_data"))) bool8 gUnknown_0203CDA4[4] = {0};
static __attribute__((section("ewram_data"))) u16 gUnknown_0203CDA8 = 0;
static __attribute__((section("ewram_data"))) void *gUnknown_0203CDAC[0x20] = {((void *)0)};
...
{
    gUnknown_0203CDA4[bgId] = 1;
}

void do_scheduled_bg_tilemap_copies_to_vram(void)
{
    if (gUnknown_0203CDA4[0] == 1)
    {
        CopyBgTilemapBufferToVram(0);
        gUnknown_0203CDA4[0] = 0;
    }
    if (gUnknown_0203CDA4[1] == 1)
    {
        CopyBgTilemapBufferToVram(1);
        gUnknown_0203CDA4[1] = 0;
    }
    if (gUnknown_0203CDA4[2] == 1)
    {
        CopyBgTilemapBufferToVram(2);
        gUnknown_0203CDA4[2] = 0;
    }
    if (gUnknown_0203CDA4[3] == 1)
    {
        CopyBgTilemapBufferToVram(3);
        gUnknown_0203CDA4[3] = 0;
    }
}
...
{
    int i;
    for (i = 0; i < (s32)(size_t)(sizeof(gUnknown_0203CDAC) / sizeof((gUnknown_0203CDAC)[0])); i++)
    {
        gUnknown_0203CDAC[i] = ((void *)0);
    }
    gUnknown_0203CDA8 = 0;
}
...
bool8 free_temp_tile_data_buffers_if_possible(void)
{
    ...
    if (!IsDma3ManagerBusyWithBgCopy())
    {
        if (gUnknown_0203CDA8)
        {
            ...
            {
                { Free(gUnknown_0203CDAC[i]); gUnknown_0203CDAC[i] = ((void *)0); };
            }
            gUnknown_0203CDA8 = 0;
        }
        return 0;
...
{
    u32 sizeOut;
    if (gUnknown_0203CDA8 < (size_t)(sizeof(gUnknown_0203CDAC) / sizeof((gUnknown_0203CDAC)[0])))
    {
