...
bool8 CheckRelicanthWailord(void)
{
    ...
    if (GetMonData(&gPlayerParty[0], 65, 0) == 314)
    {
        CalculatePlayerPartyCount();

        if (GetMonData(&gPlayerParty[gPlayerPartyCount - 1], 65, 0) == 381)
            return 1;
    }
    return 0;
}
