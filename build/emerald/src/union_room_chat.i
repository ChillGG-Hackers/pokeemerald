...
__attribute__((section("ewram_data"))) struct UnionRoomChat *gUnknown_02022C84 = ((void *)0);
__attribute__((section("ewram_data"))) struct UnionRoomChat2 *gUnknown_02022C88 = ((void *)0);
__attribute__((section("ewram_data"))) struct UnionRoomChat3 *gUnknown_02022C8C = ((void *)0);
...
static const u8 *const sUnionRoomKeyboardText[UNION_ROOM_KB_PAGE_COUNT][10] =
{
    [UNION_ROOM_KB_PAGE_UPPER] =
    {
...
const struct MenuAction gUnknown_082F2DC8[] = {
    {gText_Upper, ((void *)0)},
    {gText_Lower, ((void *)0)},
    {gText_Symbols, ((void *)0)},
    {gText_Register2, ((void *)0)},
    {gText_Exit2, ((void *)0)},
};
...
static void sub_801E668(void)
{
    ...
    case 1:
        ...
        break;
    case 2:
        if (sub_801F644(0) != 1 && IsLinkTaskFinished() && !sub_8011A9C())
        {
            sub_800AC34();
            gUnknown_02022C84->unkA = 0;
            gUnknown_02022C84->unk6++;
...
static void sub_801E764(void)
{
    ...
    case 1:
        if (IsLinkTaskFinished() == 1 && !sub_8011A9C() && SendBlock(0, gUnknown_02022C84->unk190, sizeof(gUnknown_02022C84->unk190)))
            gUnknown_02022C84->unk6++;
        break;
    case 2:
        sub_801EE10();
...
static void sub_801EE10(void)
{
    gUnknown_02022C84->unk1A[0] = 0xFF;
...
static void sub_801EF24(u8 *arg0)
{
    ...
    arg0[1 + (7 + 1)] = gUnknown_02022C84->unk13;
}
...
static void sub_801EF4C(u8 *arg0)
{
    arg0[0] = 1;
    StringCopy(&arg0[1], gSaveBlock2Ptr->playerName);
    StringCopy(&arg0[1 + (7 + 1)], gUnknown_02022C84->unk1A);
}
...
static bool8 sub_801F4D0(void)
{
    ...
    if (gUnknown_02022C88 && sub_8020890())
    {
        ...
        InitBgsFromTemplates(0, gUnknown_082F2C60, (size_t)(sizeof(gUnknown_082F2C60) / sizeof((gUnknown_082F2C60)[0])));
...
static void sub_801F544(void)
{
    ...
    if (gUnknown_02022C88)
        { Free(gUnknown_02022C88); gUnknown_02022C88 = ((void *)0); };
...
static void sub_801FDDC(u8 left, u8 top, u8 initialCursorPos)
{
    ...
    {
        FillWindowPixelBuffer(gUnknown_02022C88->unk18, ((1) | ((1) << 4)));
        PutWindowTilemap(gUnknown_02022C88->unk18);
        AddTextPrinterParameterized(gUnknown_02022C88->unk18, 1, gText_Yes, 8, 1, 0xFF, ((void *)0));
        AddTextPrinterParameterized(gUnknown_02022C88->unk18, 1, gText_No, 8, 17, 0xFF, ((void *)0));
...
static void sub_801FEBC(void)
{
    if (gUnknown_02022C88->unk18 != 0xFF)
    {
        ClearStdWindowAndFrameToTransparent(gUnknown_02022C88->unk18, 0);
...
static void sub_8020094(void)
{
    if (gUnknown_02022C88->unk1E != 0xFF)
    {
        ClearStdWindowAndFrameToTransparent(gUnknown_02022C88->unk1E, 0);
...
static void sub_8020118(u16 x, u8 *str, u8 fillValue, u8 arg3, u8 arg4)
{
    ...
    AddTextPrinterParameterized3(1, 2, x * 8, 1, sp, 0xFF, str2);
}
...
static void sub_80201A4(void)
{
    ...
    if (page != UNION_ROOM_KB_PAGE_COUNT)
    {
        ...
        for (i = 0, top = 0; i < 10; i++, top += 12)
        {
            ...
            AddTextPrinterParameterized3(2, 0, left, top, sp, 0xFF, &sp[4]);
        }
    }
    else
    {
        ...
        for (i = 0, top = 0; i < 10; i++, top += 12)
        {
            ...
            {
                AddTextPrinterParameterized3(2, 0, left, top, sp, 0xFF, str2);
            }
            else
            {
                ...
                AddTextPrinterParameterized3(2, 0, left, top, sp, 0xFF, &sp[4]);
                AddTextPrinterParameterized3(2, 0, left + 35, top, sp, 0xFF, gText_Ellipsis);
            }
        }
    }
}
...
static void sub_8020604(void)
{
    ...
    if (ptr)
    {
        CpuFastSet(&ptr[0x220], gUnknown_02022C88->unk2128, ((0x20)/(32/8) & 0x1FFFFF));
        CpuFastSet(&ptr[0x420], gUnknown_02022C88->unk2148, ((0x20)/(32/8) & 0x1FFFFF));
    }
